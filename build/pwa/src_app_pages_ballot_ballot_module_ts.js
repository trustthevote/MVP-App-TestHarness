...
let BallotPage = class BallotPage {
    constructor(formBuilder, toastController, router, alertctrl, userService) {
        ...
        this.signupForm = this.formBuilder.group({
            firstName: [
                ...
                [
                    ...
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.pattern('^[a-zA-Z-( )][\x20-\x7F]+$'), // allow only letters, spaces, hyphens and PrintableASCII chars
                ],
            ],
            lastName: [
                '',
